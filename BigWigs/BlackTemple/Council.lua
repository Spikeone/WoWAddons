...
L:RegisterTranslations("ruRU", function() return {
	...
	shield_message = "Отражающий щит на Маланде!",

	poison = "Смертельный яд",
	poison_desc = "Предупреждать о поражении Смертельным ядом игроков.",
	poison_other = "%s поражен Смертельным ядом!",
	poison_you = "Смертельный яд на ВАС!",

	icon = "Рейдовая иконка",
	icon_desc = "Помечать рейдовой иконкой человека пораженного Смертельным ядом.",

	circle = "Исцеляющий круг",
	...
	res_desc = "Предупреждать когда Гатиос Раскольщик получает Ауру всецветного сопротивления.",
	res_message = "Гатиос: сопротивления на 30 сек!",
	res_bar = "Аура сопротивления",

	blizzard = "В Снежной буре",
	blizzard_desc = "Предупреждать когда вы попадаете в Снежную бурю.",
	blizzard_message = "Вы в Снежной буре!",
} end )
