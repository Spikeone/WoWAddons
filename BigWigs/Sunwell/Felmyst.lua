...
L:RegisterTranslations("ruRU", function() return {
	encaps = "Капсула",
	encaps_desc = "Предупреждение о капсуле.",
	encaps_warning = "Капсула примерно через 5 секунд!",
	encaps_message = "Капсула: %s",
	...
	breath_nextbar = "~Осталось до дыхания (%d)",
	breath_warn = "Дыхание номер (%d)!",

	dispel = "Результаты массового рассеивания",
	dispel_desc = "Для жрецов выводит, с кого вы не сняли массовым рассеиванием нову.",
	dispel_fail = "Газ не снят с: ",

	warning = "Внимание\n--\nДля сканирования капсул необходимо установить список танков!!",
} end )
