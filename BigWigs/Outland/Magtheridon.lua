...
L:RegisterTranslations("ruRU", function() return {
	...
	abyssal = "Горящий дух Бездны",
	abyssal_desc = "Предупреждать о создании Горящего духа Бездны.",
	...
	banish = "Изгнание",
	banish_desc = "Предупреждать о Изгнании Магтеридона.",
	banish_trigger = "Только не опять! Не опять!",
	banish_message = "Изгнан на ~10сек",
	banish_over_message = "Изгнание рассеялось!",
	banish_bar = "Изгнан",

	exhaust = "Отключить полосу Изнурения разума",
	exhaust_desc = "Таймеры для Изнурение разума на игроках.",
	exhaust_bar = "[%s] изнурённый",

	debris = "Обломок на Вас",
	debris_desc = "Предупреждать когда Обломок на Вас.",
