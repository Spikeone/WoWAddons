...
function mod:OnEnable()
    ...
    --self:AddCombatListener("ENVIRONMENTAL_DAMAGE","CheckEnvDamage")
    self:AddCombatListener("ENVIRONMENTAL_DAMAGE")
...
--function mod:CombatEvent(arg1, timestamp, event, sourceGUID, sourceName, sourceFlags, destGUID, destName, destFlags, ...)
--    --SendChatMessage(arg1, "SAY")
--    --SendChatMessage(timestamp, "SAY")
--    --SendChatMessage(event, "SAY")
--    --SendChatMessage(sourceGUID, "SAY")
--    --SendChatMessage(sourceName, "SAY")
--    --SendChatMessage(sourceFlags, "SAY")
--    --SendChatMessage(destGUID, "SAY")
--    --SendChatMessage(destName, "SAY")
--    local amount, school, resisted, blocked, absorbed, critical, glancing, crushing
--    local spellId, spellName, spellSchool, missType, powerType, extraAmount, environmentalType
...
--    end
--    SendChatMessage(resisted, "SAY")
--    SendChatMessage(critical, "SAY")
--
--end
...
--function mod:CHAT_MSG_PARTY(msg)
--    SendChatMessage(L["grip_you"], "SAY")
--end
