...
local fullName = name--.."-"..realm		--no need for realm on this server
...
local function Constructor()
    ...
    local button = CreateFrame("BUTTON", name, UIParent, WotLK and "OptionsListButtonTemplate" or "InterfaceOptionsButtonTemplate")
    button:SetHeight(32);
