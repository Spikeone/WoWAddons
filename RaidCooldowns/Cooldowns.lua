...
local cooldowns = {
    ["DRUID"] = {
        ...
        [GetSpellInfo(20748)] = { id = 20748, cd = 1200},           -- Rebirth (Rank 5)
        [GetSpellInfo(20747)] = { id = 20747, cd = 1200},           -- Rebirth (Rank 4)
        [GetSpellInfo(20742)] = { id = 20742, cd = 1200},           -- Rebirth (Rank 3)
        [GetSpellInfo(20739)] = { id = 20739, cd = 1200},           -- Rebirth (Rank 2)
        [GetSpellInfo(20484)] = { id = 20484, cd = 1200},           -- Rebirth (Rank 1)
    ...
    ["SHAMAN"] = {
        ...
        [GetSpellInfo(32182)]  = { id = 32182,  cd = 600 },           -- Bloodlust/Heroism
        [GetSpellInfo(2825)]  = { id = 2825,  cd = 600 },           -- Bloodlust/Heroism
        [GetSpellInfo(16188)] = { id = 16188, cd = 180 },           -- Nature's Swiftness
        [GetSpellInfo(20608)] = { id = 20608, cd = 3600, ora = 2 }, -- Reincarnation
        [GetSpellInfo(21169)] = { id = 21169, cd = 3600, ora = 2 }, -- Reincarnation 2?
