...
PP_ZoneTable = {
    ...
    [47] = {ztype = "DN", en = "Battle for Mount Hyjal", de = "Hyjalgipfel", fr = "La bataille pour le mont Hyjal", es = "Battle for Mount Hyjal", Continent = 1, Location = 15, LevelRange = "70+", PlayerLimit = "25",  infoline = METAMAP_COT_INFO, texture = "MountHyjal"},
    ...
    [52] = {ztype = "DN", en = "The Black Temple", de = "Der Schwarze Tempel", fr = "The Black Temple", es = "The Black Temple", Continent = 3, Location = -1, LevelRange = "70+", PlayerLimit = "25", infoline = METAMAP_BT_INFO, texture = "TheBlackTemple"}
}

--[[PP_BuffPriority = {
	[1] = {role = "PALADIN_TANK", buff1 = {"SDRef", false}, buff2 = {"SDK", false}, buff3 = {"SDM", false},
    buff4 = {"SDW", false}, buff5 = {"SDL", false}, buff6 = {"", false}},
	[2] = {role = "PALADIN_HEAL", buff1 = {"SDR", false}, buff2 = {"SDK", false}, buff3 = {"SDW", false},
    buff4 = {"SDL", false}, buff5 = {"SDRef", false}, buff6 = {"SDM", false}},
	[3] = {role = "PALADIN_MELEE", buff1 = {"SDR", false}, buff2 = {"SDM", false}, buff3 = {"SDK", false},
    buff4 = {"SDW", false}, buff5 = {"SDL", false}, buff6 = {"SDRef", false}},
	[4] = {role = "DRUID_TANK", buff1 = {"SDK", false}, buff2 = {"SDM", false}, buff3 = {"SDW", false},
    buff4 = {"SDL", false}, buff5 = {"SDRef", false}, buff6 = {"", false}},
	[5] = {role = "DRUID_OFF_TANK", buff1 = {"SDR", false}, buff2 = {"SDK", false}, buff3 = {"SDM", false},
    buff4 = {"SDW", false}, buff5 = {"SDL", false}, buff6 = {"SDRef", false}},
	[6] = {role = "DRUID_MELEE", buff1 = {"SDR", false}, buff2 = {"SDK", false}, buff3 = {"SDM", false},
    buff4 = {"SDW", false}, buff5 = {"SDL", false}, buff6 = {"SDRef", false}},
	[7] = {role = "DRUID_CASTER", buff1 = {"SDR", false}, buff2 = {"SDK", false}, buff3 = {"SDW", false},
    buff4 = {"SDL", false}, buff5 = {"SDRef", false}, buff6 = {"SDM", false}},
	[8] = {role = "DRUID_HEAL", buff1 = {"SDR", false}, buff2 = {"SDK", false}, buff3 = {"SDW", false},
    buff4 = {"SDL", false}, buff5 = {"SDRef", false}, buff6 = {"SDM", false}},
	[9] = {role = "WARRIOR_TANK", buff1 = {"SDK", false}, buff2 = {"SDM", false}, buff3 = {"SDRef", false},
    buff4 = {"SDL", false}, buff5 = {"SDW", false}, buff6 = {"", false}},
	[10] = {role = "WARRIOR_OFF_TANK", buff1 = {"SDR", false}, buff2 = {"SDK", false}, buff3 = {"SDM", false},
    buff4 = {"SDRef", false}, buff5 = {"SDL", false}, buff6 = {"SDW", false}},
	[11] = {role = "WARRIOR_MELEE", buff1 = {"SDR", false}, buff2 = {"SDK", false}, buff3 = {"SDM", false},
    buff4 = {"SDL", false}, buff5 = {"SDRef", false}, buff6 = {"SDW", false}},
	[12] = {role = "SHAMAN_MELEE", buff1 = {"SDR", false}, buff2 = {"SDM", false}, buff3 = {"SDK", false},
    buff4 = {"SDW", false}, buff5 = {"SDL", false}, buff6 = {"SDRef", false}},
	[13] = {role = "SHAMAN_CASTER", buff1 = {"SDR", false}, buff2 = {"SDK", false}, buff3 = {"SDW", false},
    buff4 = {"SDL", false}, buff5 = {"SDRef", false}, buff6 = {"SDM", false}},
	[14] = {role = "SHAMAN_HEAL", buff1 = {"SDR", false}, buff2 = {"SDK", false}, buff3 = {"SDW", false},
    buff4 = {"SDL", false}, buff5 = {"SDRef", false}, buff6 = {"SDM", false}},
	[15] = {role = "PRIEST_CASTER", buff1 = {"SDR", false}, buff2 = {"SDK", false}, buff3 = {"SDW", false},
    buff4 = {"SDL", false}, buff5 = {"SDRef", false}, buff6 = {"SDM", false}},
	[16] = {role = "WARLOCK_CASTER", buff1 = {"SDR", false}, buff2 = {"SDK", false}, buff3 = {"SDW", false},
    buff4 = {"SDL", false}, buff5 = {"SDRef", false}, buff6 = {"SDM", false}},
	[17] = {role = "HUNTER_MELEE", buff1 = {"SDM", false}, buff2 = {"SDK", false}, buff3 = {"SDR", false},
    buff4 = {"SDW", false}, buff5 = {"SDL", false}, buff6 = {"SDRef", false}},
	[18] = {role = "MAGE_CASTER", buff1 = {"SDR", false}, buff2 = {"SDK", false}, buff3 = {"SDW", false},
    buff4 = {"SDL", false}, buff5 = {"SDRef", false}, buff6 = {"SDM", false}},
	[19] = {role = "ROGUE_MELEE", buff1 = {"SDR", false}, buff2 = {"SDM", false}, buff3 = {"SDK", false},
    buff4 = {"SDL", false}, buff5 = {"SDRef", false}, buff6 = {"SDW", false}},
}]]
--[[ Buffs:
1: SDW
...
PP_BuffPriority = {
    [1] = {role = "PALADIN_TANK", amount = 0, 6, 5, 2, 1, 4},
    [2] = {role = "PALADIN_HEAL", amount = 0, 3, 5, 1, 4, 6, 2},
    [3] = {role = "PALADIN_MELEE", amount = 0, 3, 2, 5, 1, 4, 6},
    [4] = {role = "DRUID_TANK", amount = 0, 5, 2, 1, 4, 6},
    [5] = {role = "DRUID_OFF_TANK", amount = 0, 3, 5, 2, 1, 4, 6},
    [6] = {role = "DRUID_MELEE", amount = 0, 3, 5, 2, 1, 4, 6},
    [7] = {role = "DRUID_CASTER", amount = 0, 3, 5, 1, 4, 6, 2},
    [8] = {role = "DRUID_HEAL", amount = 0, 3, 5, 1, 4, 6, 2},
    [9] = {role = "WARRIOR_TANK", amount = 0, 5, 2, 6, 4, 1},
    [10] = {role = "WARRIOR_OFF_TANK", amount = 0, 3, 5, 2, 6, 4, 1},
    [11] = {role = "WARRIOR_MELEE", amount = 0, 3, 5, 2, 4, 6, 1},
    [12] = {role = "SHAMAN_MELEE", amount = 0, 3, 2, 5, 1, 4, 6},
    [13] = {role = "SHAMAN_CASTER", amount = 0, 3, 5, 1, 4, 6, 2},
    [14] = {role = "SHAMAN_HEAL", amount = 0, 3, 5, 1, 4, 6, 2},
    [15] = {role = "PRIEST_CASTER", amount = 0, 3, 5, 1, 4, 6, 2},
    [16] = {role = "WARLOCK_CASTER", amount = 0, 3, 5, 1, 4, 6, 2},
    [17] = {role = "HUNTER_MELEE", amount = 0, 2, 5, 3, 1, 4, 6},
    [18] = {role = "MAGE_CASTER", amount = 0, 3, 5, 1, 4, 6, 2},
    [19] = {role = "ROGUE_MELEE", amount = 0, 3, 2, 5, 4, 6, 1},
}
--[[PP_BuffPriority = {
