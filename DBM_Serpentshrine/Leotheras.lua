...
function Leotheras:OnCombatStart(delay)
	...
	self:StartStatusBarTimer(22, "Next Whirlwind", "Interface\\Icons\\Ability_Whirlwind");
...
function Leotheras:OnEvent(event, arg1)
	if event == "CHAT_MSG_MONSTER_YELL" then
		if string.find(arg1, DBM_LEO_YELL_DEMON) then
			...
			self:ScheduleSelf(45, "PhaseWarn");
			self:ScheduleSelf(50, "NormalForm");
			...
			self:StartStatusBarTimer(50, "Normal Form", "Interface\\Icons\\INV_Weapon_ShortBlade_07");
