...
Kal:AddOption("DispelCoA", false, DBM_KAL_OPTION_DISPEL)
...
function Kal:OnSync(msg, sender)
	...
	elseif msg:sub(0, 3) == "CoA" then
        ...
        if self.Options.DispelCoA then
            self:StartStatusBarTimer(16, "CoA-Dispel: "..msg, "Interface\\Icons\\Spell_Shadow_CurseOfSargeras")
        end
	elseif msg:sub(0, 4) == "ECoA" then
        ...
        if self.Options.DispelCoA then
            self:EndStatusBarTimer("CoA-Dispel: "..msg)
        end
