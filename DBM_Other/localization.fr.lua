...
DBM_KAZZAK_INFO			= "Pr\195\169viens r\195\169guli\195\168rement de l'approche du mode Supr\195\170me.";
DBM_KAZZAK_START_YELL			= "Pour la L\195\169gion ! Pour Kil'Jaeden !";
DBM_KAZZAK_NAME			= "Seigneur Kazzak";
DBM_KAZZAK_BAR_TEXT			= "Mode Supreme";
...
DBM_KAZZAK_ANNOUNCE_SEC		= "*** %d sec avant mode supreme***";

-- LVAzuregos
DBM_AZUREGOS_NAME			= "Azuregos";
DBM_AZUREGOS_INFO			= "Pr\195\169viens quans Azuregos t\195\169l\195\169porte quelqu'un et est prot\195\169g\195\169 par un bouclier magique";
