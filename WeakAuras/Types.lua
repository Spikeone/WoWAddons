...
WeakAuras.unit_types = {
  player = L["Player"],
  vehicle = function() local s = string.gsub(UNITNAME_SUMMON_TITLE9, "%%s" , "") local a,b = string.find(s, "%a%a%a%a+") return (string.sub(s, a or 0, b or 0) or "Vehicle") end,
  target = L["Target"],
  focus = L["Focus"],
  group = L["Group"],
...
local C_S_O, R_C_C, L_C_N_M, F_C_C_C =  CLASS_SORT_ORDER, RAID_CLASS_COLORS, _G.LOCALIZED_CLASS_NAMES_MALE, _G.FONT_COLOR_CODE_CLOSE
do
...
WeakAuras.texture_types = {
  ["Cataclysm Alerts"] = {
    ...
    ["Interface\\AddOns\\WeakAuras\\Media\\SpellActivationOverlays\\Natures_Grace"] = "Nature's Grace",
    ["Interface\\AddOns\\WeakAuras\\Media\\SpellActivationOverlays\\Nightfall"] = "Nightfall",
    ...
    ["Interface\\AddOns\\WeakAuras\\Media\\SpellActivationOverlays\\Backlash"] = "Backslash",
    ...
    ["Interface\\AddOns\\WeakAuras\\Media\\SpellActivationOverlays\\Feral_OmenOfClarity"] = "Omen of Clarity (Feral)",
    ...
    ["Interface\\AddOns\\WeakAuras\\Media\\SpellActivationOverlays\\Necropolis"] = "Necropolis",
